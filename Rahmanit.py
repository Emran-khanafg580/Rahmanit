#Decode :- https://t.me/KGF_TERMUX_TEAM
...
\033[1;93m|\033[1;91m>> Tool Virsion : 8.3 Pro  
\033[1;93m|\033[1;91m>> Decode by :- https://t.me/KGF_TERMUX_TEAM                         \033[1;93m |
\033[1;93m×××××××××××××××××××××××××××××××××××××××××××××××××××××××""")
print(logo)
CorrectUsername = 'KALYAN'
key = 'true'
while key == 'true':
